...
source: https://worldpopulationreview.com/us-counties/tx/bexar-county-population (from US census)

|Feature|Datatype|Definition|
| total_consumption    | 36 non-null: int64 |    The total annual water use estimates for Bexar county from 1984 - 2019 |
source: https://www.twdb.texas.gov/waterplanning/waterusesurvey/estimates/index.asp (from Texas Water Development Board)
---
...
- Retrieve the dataand put it into a usable Pandas dataframe.
...
- Find and establish baseline RSME base on various methods. Using the best of these "simple predictors" will give me an RSME level to beat with my models
...
- In order to run through this project yourself you will need to copy all material listed in this github repo. Similarly you could download the original data from the sources provided above in this readme.
